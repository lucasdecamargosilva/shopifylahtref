(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=lahtref';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos-lahtref';
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <img src="https://lahtref.com.br/cdn/shop/files/Branco_3_26f2922f-11f1-47e6-b88d-325fa7817035.png?v=1697985851&width=240" alt="LAHTREF" style="height:48px;width:auto;filter:brightness(0);"/>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=lahtref" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=lahtref" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
    ...
    function init() {
        ...
        // Botão inline DESATIVADO na Lahtref — só o pill flutuante sobre a foto
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'lahtref', origin: location.origin })
                    });
                    pix = await resp.json();
...
const fd = new FormData();
                    ...
                    for (let _pi = 0; _pi < allProdImgs.length; _pi++) {
                        try {
                            ...
                            if (!_bRaw || !/^image\//i.test(_bRaw.type)) continue; // pula HTML/nao-imagem -> evita 400 do gerador (ALTA DEMANDA)
